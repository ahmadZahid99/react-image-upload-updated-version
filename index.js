    ...
    if( this.state.files.length > 0 ){
      ...
      let imageArray = [];
         ...
         for(let i = 0; i < this.state.files.length; i++){
          ...
          //making the array of files name

               imageArray = [...imageArray, this.state.files[i].name];

           }
           
           //this index use for filter file
           ...
           if(imageArray.length > 0){
            ...
            for(let x=0; x < imageArray.length; x++){
              ...
              if(this.state.pictures[removeIndex].includes(imageArray[x])){
                newindex = x;
              }
...
//filter the file if index is not null
...
//seting state
    ...
    this.setState({ pictures: filteredPictures, files: this.state.files }, function () {
      _this3.props.onChange(_this3.state.files, _this3.state.pictures);
    });
  }
  }
